...
class InitializeDatabaseDAO:
    ...
    def create_tables(self) -> None:
        table_create_queries: list[str] = ['''CREATE TABLE IF NOT EXISTS users_config(user_id INTEGER NOT NULL UNIQUE, only_new VARCHAR(3), max_size INTEGER, name_filter VARCHAR(3), price_filter VARCHAR(3), language VARCHAR(2))''',
